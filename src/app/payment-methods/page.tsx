    ...
    : [
        {
          ...
          name: "PayPal",
          description:
            "Manual or semi-manual order flow with admin review.",
          recommended: true,
          ...
          instructionsBody:
            "Copy the admin-configured PayPal email or payment link, use the provided reference, then upload proof if required.",
          ...
          requiresProof: true,
          proofHelpText:
            "A screenshot can help the admin validate faster.",
        ...
        },
        {
          ...
          name: "Paysafecard",
          description:
            "Code submission reviewed manually by an operator.",
          recommended: false,
          maintenanceMode: false,
          feePercent: 2.5,
          feeFixed: 0,
          ...
          instructionsBody:
            "Enter the code securely, then wait for manual validation.",
    ...
    <section className="container-app py-16 md:py-20">
      <div className="max-w-4xl space-y-4">
        ...
        <p className="text-lg leading-8 text-muted">
          Every method exposes fees, supported assets, instructions,
          proof requirements, and support links before the user submits an order.
        </p>
      </div>
          ...
          <Card key={method.id} className="space-y-5 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Card className="p-4">
                ...
                <p className="mt-2 font-semibold text-text">
                  {method.estimatedDelay || "Configured in admin"}
                </p>
              </Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="space-y-2 p-4">
                ...
                <p className="font-semibold text-text">
                  {method.instructionsTitle ||
                    "How to complete the payment"}
                </p>
                <p className="whitespace-pre-wrap text-sm leading-7 text-muted">
                  {method.instructionsBody ||
                    "The admin can configure detailed instructions."}
                </p>
              </Card>
              ...
              <Card className="space-y-2 p-4">
                ...
                <p className="text-sm text-muted">
                  {method.recipientLabel || "Recipient"}
                </p>

                <p className="font-semibold text-text">
                  {method.recipientValue ||
                    method.paymentLink ||
                    "Configured in admin"}
                </p>
